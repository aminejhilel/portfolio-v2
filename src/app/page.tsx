      ...
      <header className="fixed top-4 left-0 right-0 z-50 flex justify-center px-4">
        <div className="flex items-center justify-between bg-slate-900/80 backdrop-blur-xl border border-slate-700/50 shadow-2xl rounded-2xl px-4 py-2 w-full max-w-6xl">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a href="#presentation" className="text-sm font-medium text-slate-300 hover:text-white transition-colors relative group">
              Présentation
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-teal-400 transition-all group-hover:w-full"></span>
            </a>
            <a href="#experiences" className="text-sm font-medium text-slate-300 hover:text-white transition-colors relative group">
              Parcours Pro
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-teal-400 transition-all group-hover:w-full"></span>
            </a>
            <a href="#formations" className="text-sm font-medium text-slate-300 hover:text-white transition-colors relative group">
              Formations
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-teal-400 transition-all group-hover:w-full"></span>
            </a>
            <a href="#competences" className="text-sm font-medium text-slate-300 hover:text-white transition-colors relative group">
              Compétences
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-teal-400 transition-all group-hover:w-full"></span>
            </a>
          ...
          <Card className="relative overflow-hidden">
            <CardContent className="pt-8">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-8">
                ...
                >
                  <div className="h-12 w-12 rounded-full bg-emerald-500/10 flex items-center justify-center text-emerald-400 group-hover:scale-110 group-hover:bg-emerald-500/20 transition-all">
                    <WhatsAppIcon size={24} />
                  </div>
                  <span className="font-medium text-slate-300 group-hover:text-emerald-400 transition-colors">WhatsApp</span>
                </a>

                <a
                  href="https://linkedin.com/in/mohammed-benrabah"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center justify-center gap-3 p-6 rounded-2xl bg-slate-950 border border-slate-800 hover:border-blue-500/50 hover:bg-blue-500/5 transition-all group"
                >
                  <div className="h-12 w-12 rounded-full bg-blue-500/10 flex items-center justify-center text-blue-400 group-hover:scale-110 group-hover:bg-blue-500/20 transition-all">
                    <LinkedinIcon size={24} />
                  </div>
                  <span className="font-medium text-slate-300 group-hover:text-blue-400 transition-colors">LinkedIn</span>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center justify-center gap-3 p-6 rounded-2xl bg-slate-950 border border-slate-800 hover:border-blue-600/50 hover:bg-blue-600/5 transition-all group"
                >
                  <div className="h-12 w-12 rounded-full bg-blue-600/10 flex items-center justify-center text-blue-500 group-hover:scale-110 group-hover:bg-blue-600/20 transition-all">
                    <FacebookIcon size={24} />
                  </div>
                  <span className="font-medium text-slate-300 group-hover:text-blue-500 transition-colors">Facebook</span>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center justify-center gap-3 p-6 rounded-2xl bg-slate-950 border border-slate-800 hover:border-pink-500/50 hover:bg-pink-500/5 transition-all group"
                >
                  <div className="h-12 w-12 rounded-full bg-pink-500/10 flex items-center justify-center text-pink-400 group-hover:scale-110 group-hover:bg-pink-500/20 transition-all">
                    <InstagramIcon size={24} />
                  </div>
                  <span className="font-medium text-slate-300 group-hover:text-pink-400 transition-colors">Instagram</span>
                </a>
              </div>
            </CardContent>
          </Card>
